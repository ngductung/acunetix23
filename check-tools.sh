...
#curl https://github.com/ngductung/acunetix23/raw/main/awvs.sh -O /awvs/awvs.sh
...
if [[ "$LAST_VERSION" == 14.* ]]; then
    check_zip_url="https://github.com/ngductung/acunetix23/raw/main/awvs14_listen.zip"
fi

if [[ "$LAST_VERSION" == 15.* ]]; then
    check_zip_url="https://github.com/ngductung/acunetix23/raw/main/awvs15_listen.zip"
    #  check_zip_url="http://192.168.0.102:8083/awvs15_listen.zip" # TODO
fi

if [[ -z "$check_zip_url" ]]; then
    check_zip_url="https://github.com/ngductung/acunetix23/raw/main/awvs_listen.zip"
fi
# <== 获取破解包地址
